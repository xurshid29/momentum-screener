...
# Usage: ./screener-poll_2min_5percent.sh
...
URL="https://elite.finviz.com/export.ashx?v=140&f=ta_change_u10,ta_perf_5to-i2&ft=4&o=-change&pt=1&auth=${FINVIZ_API_TOKEN}"
INTERVAL=10
...
echo "Filters: Change up 10%, Perf 5% to -2%"
